...
AS $$
DECLARE
  project_url TEXT := 'https://lrmdpqutopbyjprdeflp.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxybWRwcXV0b3BieWpwcmRlZmxwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MTE4NDgzNjcsImV4cCI6MjAyNzQyNDM2N30.dg5ghVAcg0nY24Airfq96EsajGl9XVMAlU-QVocM8pI'; -- full access needed for http request to storage
